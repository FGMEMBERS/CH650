...
setlistener("/controls/heating/cabin", func(v) {
  if(v.getValue()){
    interpolate("/controls/heating/cabin-pos", 1, 0.25);
  }else{
    interpolate("/controls/heating/cabin-pos", 0, 0.25);
  }
});
setlistener("/controls/heating/carb", func(v) {
  if(v.getValue()){
    interpolate("/controls/heating/carb-pos", 1, 0.25);
  }else{
    interpolate("/controls/heating/carb-pos", 0, 0.25);
  }
});
